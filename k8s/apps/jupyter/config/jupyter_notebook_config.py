...
#  Default: ''
c.NotebookApp.websocket_url = 'wss://jupyter.starry.blue'
...
#  Choices: any of ['sha384', 'blake2s', 'sha3_224', 'sha256', 'sha3_384', 'sha3_256', 'sha1', 'sha512', 'md5', 'sha3_512', 'sha224', 'blake2b']
#  Default: 'sha256'
